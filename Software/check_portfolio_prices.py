...
with open("/home/pi/portfolio.txt") as f:	#Open portfolio file for reading
...
#	print >> f, list[x].ticker + " " + str(list[x].quantity) + " " + str(list[x].open_price) + " " + str(list[x].current_price) + " " + str(list[x].daily_change) + "\n"
	print >> f, list[x].ticker + " " + str(list[x].current_price) + " " + str(list[x].total_change) + " " + str("{:.2f}".format(list[x].total_change_pc)) + "\n"
